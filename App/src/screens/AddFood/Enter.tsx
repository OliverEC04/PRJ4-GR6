...
export default function AddFoodPage() {
  ...
  const fetchMeals = async () => {
    try {
      ...
      const response = await fetch(
        "https://brief-oriole-causal.ngrok-free.app/api/Barcode/ListOfBarcodesForUser",
        { headers }
      );
  ...
  const handleAddNewFood = async () => {
    try {
      const headers = { Authorization: "Bearer " + currentUser.token };
      const response = await fetch(
        `https://brief-oriole-causal.ngrok-free.app/api/Barcode/AddMealWithNoBarcode?mealName=${foodName}&calories=${calories}&protein=${protein}&carbs=${carbs}&fat=${fat}`,
        {
          method: "POST",
          headers: headers,
        }
  ...
  const handleDeleteNewFood = async () => {
    try {
      const headers = { Authorization: "Bearer " + currentUser.token };
      const response = await fetch(
        `https://brief-oriole-causal.ngrok-free.app/rest_api/api/Barcode/RemoveBarcode/${id}`,
        {
          method: "DELETE",
          headers: headers,
        }
      ...
      Alert.alert(
        "Error",
        "Failed to delete food. Please check your network connection and try again."
      );
      fetchMeals();
    }
  };

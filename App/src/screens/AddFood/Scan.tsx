        ...
        <>
          {foodInfo && !intakeInfo && (
            <View style={styles.container2}>
              <Text style={styles.modalText}>Please enter the amount of the meal you consumed in grams!</Text>
          ...
          {intakeInfo && (
            <View  style={styles.container2}>
              <Text style={styles.modalText2}>Press enter to add the amount to your daily intake!</Text>
              ...
              <View style={styles.buttonContainer}>
                ...
                <Btn onClick={handleBackButtonPress} text='back?' style={styles.backbutton} />
              </View>
            </View>
          )}
          <Btn onClick={resetScanner} text='Scan Again?' style={styles.buttons} />
          {/* Modal */}
          <Modal
            animationType="slide"
            transparent={true}

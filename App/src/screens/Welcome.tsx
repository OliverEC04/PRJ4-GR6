...
export default function Welcome({
	...
	const Activity = [
		...
		{
			label: 'Super active (very hard exercise and a physical job or training twice a day)',
			value: '190',
		},
	];
	...
	useEffect(() => {
		if (currentUser.firsTimeOrNot != 1) {
			setShowModal(true);
		}
	}, []);
		...
		>
			<View style={HomeStyle.modalView}>
				<Text style={HomeStyle.modalText}>
					Welcome to the Gym rats Fitness App! Fill out this form to
					get started
				</Text>
				{renderDropdown(
					open,
